classdef Gui < handle
    ...
    methods
        ...
        function obj = Gui(trajectory_getter, varargin)
            ...
            pos = get(obj.h_connection, 'Position');
            obj.h_clear_btn = uicontrol(obj.h_control_panel, ...
                'Style', 'pushbutton', ...
                'String', 'Clear');
            sz = get(obj.h_clear_btn, 'Position');
            set(obj.h_clear_btn, 'Position', [pos(1) + pos(3) + 20, pos(2), sz(3:4)]);
